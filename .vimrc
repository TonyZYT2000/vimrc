...
augroup myFileSettings
  ...
  " Tab settings for Javascript file
  au FileType systemverilog set expandtab     " turn tabs into spaces visually
  au FileType systemverilog set shiftwidth=4  " set width of < and > cmd to 4 spaces
  au FileType systemverilog set softtabstop=4 " pressing tab inserts 4 spaces
augroup END
